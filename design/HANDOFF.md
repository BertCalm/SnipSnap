...
| BANK B | TapeOS Oilslick.dc.html (KIT header + action row) | W4.3 — EVIL TWINS button fills bank B (twins of assigned bank-A pads, treatment tag top-right in accent 7px Silkscreen, colour-washed fill + 2px dashed class border); button becomes REROLL after first run (reshuffles treatments); a BANK A · n / BANK B · n row under the KIT header flips the grid — always drawn, B reading `BANK B · EMPTY` (ink3) until twins run, and its empty tap toasts `Copy.BANK_B_EMPTY` (what fills it) rather than flipping to blanks; the letter in the header is a readout; pad sheet is bank-A only |
...
Shipped copy adds: "MELODIC. THE PADS BECOME A SCALE, LOW LEFT." · "Am SET. TONAL PADS RETUNE ON ASSIGN — THE KICK IS UNTOUCHED." · "KEY OFF. EVERYTHING LANDS AS CAPTURED." · "TEACHING ON. THE MACHINE LEARNS FROM YOUR CORRECTIONS." · "TEACHING OFF. THE MACHINE STOPS TAKING NOTES." · "BANK B REMIXED: EVERY PAD'S EVIL TWIN. RECIPES KEPT." · "BANK B REROLLED. SAME SEED, DIFFERENT SINS." · "BANK B IS EMPTY. REMIX BANK B ▸ FILLS IT WITH EVIL TWINS." · "NOTHING WOULD CROSS: NO PAD HERE HAS A PATCH OR TREATMENT, OR A PARTNER THERE WITH ONE TO BORROW. TREAT A PAD FIRST." · "T3 RESTORED. THE PAST, REPLAYED." · "BACK FROM THE BIN. NO QUESTIONS ASKED." · "BIN EMPTIED. THE MACHINE FORGETS, AS ASKED." · "HUMANIZED. NOBODY PLAYS LIKE A ROBOT." · "FORKED TO PROG E. A–D STAY UNTOUCHED." · "BAR WIPED. THE MACHINE FORGIVES."
