...
Then, cheaply: a toast on GROOVE's disabled BOUNCE (#8), a `selected` state on SURFACE's modes and a `TILT` word in MORPH's copy (#6, #21), and the four stale documents (#23).
