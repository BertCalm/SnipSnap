...
object FathomPresets {
    ...
    // GRIND's own classifier boundary (Copilot's review of this PR — see
    // FathomPresetsTest's own KDoc) turned out chaotic across more than
    // just CUTOFF once real presets (which also vary TUNE/GLIDE/DECAY,
    // not held fixed the way a coarse sweep does) were checked directly —
    // the same "safe at one setting, misfires two hundredths away"
    // shape `ThumpPresets` found at THUMP's own HAT/TOM boundary. Rather
    // than chase a precise boundary across five dimensions, every preset
    // below sits well inside the region a sweep (ScratchSweepTest, not
    // committed) found robustly KICK regardless of the other four macros:
    // CUTOFF <= 0.22 and SPREAD <= 0.35.
    private val grindPresets = listOf(
        p(FathomVoice.GRIND, "GRINDER", "TUNE" to 0.3f, "GLIDE" to 0f, "DRIVE" to 0.5f, "CUTOFF" to 0.2f, "DECAY" to 0.6f, "SPREAD" to 0.25f),
        p(FathomVoice.GRIND, "HOLLOW GROWL", "TUNE" to 0.2f, "GLIDE" to 0f, "DRIVE" to 0.35f, "CUTOFF" to 0.18f, "DECAY" to 0.75f, "SPREAD" to 0.3f),
        p(FathomVoice.GRIND, "RAW SAW", "TUNE" to 0.4f, "GLIDE" to 0.1f, "DRIVE" to 0.65f, "CUTOFF" to 0.2f, "DECAY" to 0.45f, "SPREAD" to 0.15f),
        p(FathomVoice.GRIND, "WIDE GRIND", "TUNE" to 0.5f, "GLIDE" to 0f, "DRIVE" to 0.45f, "CUTOFF" to 0.16f, "DECAY" to 0.55f, "SPREAD" to 0.25f),
        p(FathomVoice.GRIND, "DIRTY GROWL", "TUNE" to 0.15f, "GLIDE" to 0.2f, "DRIVE" to 0.75f, "CUTOFF" to 0.16f, "DECAY" to 0.4f, "SPREAD" to 0.2f),
        p(FathomVoice.GRIND, "THROB", "TUNE" to 0.45f, "GLIDE" to 0.35f, "DRIVE" to 0.3f, "CUTOFF" to 0.2f, "DECAY" to 0.7f, "SPREAD" to 0.1f),
        p(FathomVoice.GRIND, "BEATING SUB", "TUNE" to 0.25f, "GLIDE" to 0.3f, "DRIVE" to 0.25f, "CUTOFF" to 0.19f, "DECAY" to 0.5f, "SPREAD" to 0.15f),
        p(FathomVoice.GRIND, "GRAVEL BASS", "TUNE" to 0.55f, "GLIDE" to 0.25f, "DRIVE" to 0.7f, "CUTOFF" to 0.15f, "DECAY" to 0.35f, "SPREAD" to 0.2f),
        p(FathomVoice.GRIND, "SLIDING GRIT", "TUNE" to 0.35f, "GLIDE" to 0.55f, "DRIVE" to 0.55f, "CUTOFF" to 0.2f, "DECAY" to 0.5f, "SPREAD" to 0.35f),
        p(FathomVoice.GRIND, "LOUD GRIND", "TUNE" to 0.1f, "GLIDE" to 0f, "DRIVE" to 0.9f, "CUTOFF" to 0.17f, "DECAY" to 0.3f, "SPREAD" to 0.15f),
        p(FathomVoice.GRIND, "SOFT GROWL", "TUNE" to 0.05f, "GLIDE" to 0.1f, "DRIVE" to 0.15f, "CUTOFF" to 0.19f, "DECAY" to 0.8f, "SPREAD" to 0.2f),
        p(FathomVoice.GRIND, "DETUNED GRIT", "TUNE" to 0.45f, "GLIDE" to 0.15f, "DRIVE" to 0.6f, "CUTOFF" to 0.21f, "DECAY" to 0.5f, "SPREAD" to 0.35f),
    )

    // GLASS's own boundary is the mirror image: the same sweep found PERC
    // holds reliably at DRIVE >= 0.5 AND CUTOFF >= 0.4, across the full
    // RATIO range — low DRIVE or low CUTOFF is where it drifts to TOM.
    private val glassPresets = listOf(
        ...
        p(FathomVoice.GLASS, "RINGING SUB", "TUNE" to 0.2f, "GLIDE" to 0.2f, "DRIVE" to 0.5f, "CUTOFF" to 0.45f, "DECAY" to 0.6f, "RATIO" to 0.4f),
        ...
        p(FathomVoice.GLASS, "SUBOCTAVE FM", "TUNE" to 0.15f, "GLIDE" to 0f, "DRIVE" to 0.7f, "CUTOFF" to 0.5f, "DECAY" to 0.65f, "RATIO" to 0f),
        ...
        p(FathomVoice.GLASS, "MELLOW FM", "TUNE" to 0.6f, "GLIDE" to 0.4f, "DRIVE" to 0.5f, "CUTOFF" to 0.55f, "DECAY" to 0.3f, "RATIO" to 0.1f),
