 ...
 * TUNE/VOWEL/BREATH/DECAY. VOWEL walks the A→E→I→O→U morph `Vox.kt`
 * defines; BREATH crossfades the buzzing source toward filtered noise.
...
object VoxPresets {
    ...
    private val choirPresets = listOf(
        ...
        p(VoxVoice.CHOIR, "EH CHOIR", "TUNE" to 0.5f, "VOWEL" to 0.3f, "BREATH" to 0.1f, "DECAY" to 0.55f),
        ...
        p(VoxVoice.CHOIR, "HIGH CHOIR", "TUNE" to 0.7f, "VOWEL" to 0.15f, "BREATH" to 0.2f, "DECAY" to 0.5f),
        p(VoxVoice.CHOIR, "LOW CHOIR", "TUNE" to 0.25f, "VOWEL" to 0.1f, "BREATH" to 0.1f, "DECAY" to 0.75f),
        ...
        p(VoxVoice.CHOIR, "DEEP OOH", "TUNE" to 0.2f, "VOWEL" to 0.9f, "BREATH" to 0.15f, "DECAY" to 0.8f),
    ...
    private val robotPresets = listOf(
        ...
        p(VoxVoice.ROBOT, "SPEAK BOX", "TUNE" to 0.5f, "VOWEL" to 0.5f, "BREATH" to 0.1f, "DECAY" to 0.35f),
        ...
        p(VoxVoice.ROBOT, "DROID VOICE", "TUNE" to 0.4f, "VOWEL" to 0.55f, "BREATH" to 0.15f, "DECAY" to 0.3f),
        p(VoxVoice.ROBOT, "TIGHT ROBOT", "TUNE" to 0.6f, "VOWEL" to 0.65f, "BREATH" to 0.02f, "DECAY" to 0.2f),
        p(VoxVoice.ROBOT, "LOW ROBOT", "TUNE" to 0.2f, "VOWEL" to 0.5f, "BREATH" to 0.1f, "DECAY" to 0.45f),
        p(VoxVoice.ROBOT, "HIGH ROBOT", "TUNE" to 0.7f, "VOWEL" to 0.6f, "BREATH" to 0.05f, "DECAY" to 0.2f),
    ...
    private val ghostPresets = listOf(
        ...
        p(VoxVoice.GHOST, "HAUNTED OOH", "TUNE" to 0.4f, "VOWEL" to 0.95f, "BREATH" to 0.7f, "DECAY" to 0.9f),
        ...
        p(VoxVoice.GHOST, "LOW MOAN", "TUNE" to 0.2f, "VOWEL" to 0.8f, "BREATH" to 0.55f, "DECAY" to 0.85f),
        p(VoxVoice.GHOST, "HIGH SIGH", "TUNE" to 0.65f, "VOWEL" to 0.4f, "BREATH" to 0.6f, "DECAY" to 0.4f),
